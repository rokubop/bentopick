...
async function connect() {
  ...
  socket.onopen = () => {
    ...
    // A new flick process knows none of them.
    iconsSent = new Set();
    sendTabs();
  };
...
// Decoded here rather than in flick: a service worker already has an image
// decoder, and shipping raw pixels keeps flick free of one.
...
async function sendTabs() {
  ...
  // Only what flick has not been sent on this connection. It keeps them.
  const icons = {};
  keys.forEach((key) => {
